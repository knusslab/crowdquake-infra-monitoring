...
public class ContainerDataCollectorApplication {
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(ContainerDataCollectorApplication.class);
 ...
 */
@Component
class ContainerDataCollectorRunner implements CommandLineRunner {

    private static final Logger logger = LoggerFactory.getLogger(ContainerDataCollectorRunner.class);
    ...
    @Autowired
    public ContainerDataCollectorRunner(KafkaProducerService kafkaProducerService) {
